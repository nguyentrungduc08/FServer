...
${OBJECTDIR}/src/resources/core/connection.o: src/resources/core/connection.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/connection.o src/resources/core/connection.cpp

${OBJECTDIR}/src/resources/core/connection_FileConn.o: src/resources/core/connection_FileConn.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/connection_FileConn.o src/resources/core/connection_FileConn.cpp

${OBJECTDIR}/src/resources/core/connection_MainConn.o: src/resources/core/connection_MainConn.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/connection_MainConn.o src/resources/core/connection_MainConn.cpp

${OBJECTDIR}/src/resources/core/connection_Test.o: src/resources/core/connection_Test.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/connection_Test.o src/resources/core/connection_Test.cpp

${OBJECTDIR}/src/resources/core/servercore.o: src/resources/core/servercore.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/servercore.o src/resources/core/servercore.cpp

${OBJECTDIR}/src/resources/core/servercore_FileConn.o: src/resources/core/servercore_FileConn.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/servercore_FileConn.o src/resources/core/servercore_FileConn.cpp

${OBJECTDIR}/src/resources/core/servercore_MainConn.o: src/resources/core/servercore_MainConn.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/servercore_MainConn.o src/resources/core/servercore_MainConn.cpp

${OBJECTDIR}/src/resources/core/servercore_Test.o: src/resources/core/servercore_Test.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/core/servercore_Test.o src/resources/core/servercore_Test.cpp

${OBJECTDIR}/src/resources/modules/File.o: src/resources/modules/File.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/File.o src/resources/modules/File.cpp

${OBJECTDIR}/src/resources/modules/Packet.o: src/resources/modules/Packet.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/Packet.o src/resources/modules/Packet.cpp

${OBJECTDIR}/src/resources/modules/Session.o: src/resources/modules/Session.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/Session.o src/resources/modules/Session.cpp

${OBJECTDIR}/src/resources/modules/database.o: src/resources/modules/database.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/database.o src/resources/modules/database.cpp

${OBJECTDIR}/src/resources/modules/fileHandle.o: src/resources/modules/fileHandle.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/fileHandle.o src/resources/modules/fileHandle.cpp

${OBJECTDIR}/src/resources/modules/logger.o: src/resources/modules/logger.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/logger.o src/resources/modules/logger.cpp

${OBJECTDIR}/src/resources/modules/md5.o: src/resources/modules/md5.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/md5.o src/resources/modules/md5.cpp

${OBJECTDIR}/src/resources/modules/ssl.o: src/resources/modules/ssl.cpp
	${MKDIR} -p ${OBJECTDIR}/src/resources/modules
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/resources/modules/ssl.o src/resources/modules/ssl.cpp

${OBJECTDIR}/src/srcComponent/Werror.o: src/srcComponent/Werror.cpp
	${MKDIR} -p ${OBJECTDIR}/src/srcComponent
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/srcComponent/Werror.o src/srcComponent/Werror.cpp

${OBJECTDIR}/src/srcComponent/WopenSSL.o: src/srcComponent/WopenSSL.cpp
	${MKDIR} -p ${OBJECTDIR}/src/srcComponent
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/srcComponent/WopenSSL.o src/srcComponent/WopenSSL.cpp

${OBJECTDIR}/src/srcComponent/Wsock.o: src/srcComponent/Wsock.cpp
	${MKDIR} -p ${OBJECTDIR}/src/srcComponent
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/srcComponent/Wsock.o src/srcComponent/Wsock.cpp
